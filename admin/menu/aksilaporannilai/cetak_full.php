...
session_start();
 ...
 $nama_dokumen='Laporan Nilai Siswa Keseluruhan'; //Beri nama file PDF hasil.
...
$sql=mysql_query("SELECT nilai.*, pelajaran.nama_pelajaran, siswa.nama_siswa, siswa.nis, datakelas.jurusan,  guru.nama_guru FROM siswa, pelajaran, nilai, datakelas, kelas, guru WHERE nilai.kode_siswa=siswa.kode_siswa AND nilai.kode_pelajaran=pelajaran.kode_pelajaran AND datakelas.kode_siswa=nilai.kode_siswa AND datakelas.kode_siswa=siswa.kode_siswa AND datakelas.kode_kelas=kelas.kode_kelas AND nilai.kode_guru=guru.kode_guru AND kelas.kode_kelas=nilai.kode_kelas ");
