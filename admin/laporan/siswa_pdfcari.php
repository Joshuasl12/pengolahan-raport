...
$kelas=$_GET['id'];
 $query=mysql_query("SELECT * FROM kelas WHERE kode_kelas='$kelas'");
 $tampil=mysql_fetch_array($query);
?>

<h3 align="center">DATA SISWA</h3>
<br>
<p align="left">Tahun Ajar : <?php echo $tampil['tahun_ajar']; ?></p>
<p align="left">Kelas : <?php echo $tampil['kelas']; ?></p>
<p align="left">Nama Kelas : <?php echo $tampil['nama_kelas']; ?></p>
...
$kelas=$_GET['id'];
$no=1;
$sql=mysql_query("SELECT * FROM siswa, datakelas WHERE datakelas.kode_siswa=siswa.kode_siswa AND datakelas.kode_kelas='$kelas'");
