...
<head>
    ...
    <link rel="shortcut icon" href="../images/favicon/sky.ico" type="image/x-icon">
    <link rel="icon" href="../images/favicon/sky.ico" type="image/x-icon">
...
<body>
        ...
        <div class="navbar-fixed">  
            <nav class="nlue">
                <div class="nav-wrapper">
                    <h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">Pengolahan Nilai Raport</a></h1>
        ...
        <div class="wrapper"> <!-- START WRAPPER -->
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <li class="bold"><a href="?menu=guru" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Guru</a>
                    </li>
                    <li class="bold"><a href="?menu=siswa" class="waves-effect waves-cyan"><i class="mdi-social-people"></i> Siswa</a>
                    </li>
                    <li class="no-padding">
                            ...
                            <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class=" mdi-maps-local-print-shop"></i> Cetak</a>
                                <div class="collapsible-body">
                                    <ul>
                                        ...
                                        <li><a href="?menu=laporanguru"><i class="mdi-action-description"></i>Laporan Guru</a>
                                        </li>                              
                            ...
                            <div class="col s12 m12 l12">
                                ...
                                <?php
                                    if(isset($_GET['menu'])){
                                        ...
                                        elseif($url=="guru"){ if($url2=="tambahdataguru"){ ?> <li><a href="?menu=home">Dashboard</a></li> <li><a href="?menu=guru">Guru</a></li> <li class="active">Tambah Data</li> <?php }
                                                            elseif($url2=="editdataguru"){ ?> <li><a href="?menu=home">Dashboard</a></li> <li><a href="?menu=guru">Guru</a></li> <li class="active">Edit Data</li> <?php }
                                                            else { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                            <li class="active">Guru</li> <?php } }
                                        elseif($url=="siswa"){ if($url2=="tambahdatasiswa"){ ?> <li><a href="?menu=home">Dashboard</a></li> <li><a href="?menu=siswa">Siswa</a></li> <li class="active">Tambah Data</li> <?php }
                                                            elseif($url2=="editdatasiswa"){ ?> <li><a href="?menu=home">Dashboard</a></li> <li><a href="?menu=siswa">Siswa</a></li> <li class="active">Edit Data</li> <?php }
                                                            else { ?> <li><a href="?menu=home">Dashboard</a></li>
                                        ...
                                        elseif($url=="kelassiswa"){ if($url2=="tambahdatakelassiswa"){ ?> <li><a href="?menu=home">Dashboard</a></li> <li><a href="?menu=kelassiswa">Kelas Siswa</a></li> <li class="active">Tambah Data</li> <?php }
                                         ...
                                         elseif($url=="laporanguru"){ ?> <li><a href="?menu=home">Dashboard</a></li>
                                                                    <li class="active">Laporan Guru</li> <?php }        
 ...
 <!-- Tutup breadcrumbs -->
    ...
    <div class="footer-copyright nlue">
      <div class="container">
       <span>2019 © Sistem Nilai Raport Online</span> <span class="right">Developed by <a class="grey-text text-lighten-4" href="https://www.instagram.com/joshuasatya__/">Joshua SL</a></span>
        </div>
    </div>
  </footer>
    <!-- TUTUP FOOTER -->
