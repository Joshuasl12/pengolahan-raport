...
<tr>
    <td >Nama Siswa</td>
    <td>:</td>
    <td width="270px"><?php echo $data['nama_siswa']; ?></td>
    <td>Tingkat/ Tahun ke</td>
    <td>:</td>
...
<tr bgcolor="#64b5f6">
                                                   <th rowspan="3" width="380px">Mata Pelajaran</th> 
                                                   <th rowspan="3">Semester</th> 
                                                   <th colspan="7"><center>Kelulusan</center></th>
                                            </tr>
                                            <tr bgcolor="#64b5f6">
                                                   <th rowspan="2"><center>Angka</center></th> 
                                                   <th width="300px" colspan="6"><center>Edikat</center></th> 
                                            </tr>
                                            <tr bgcolor="#64b5f6">
