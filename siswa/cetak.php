...
$sql=mysql_query("SELECT siswa.kode_siswa, siswa.nis, siswa.nama_siswa,
                                        ...
                                        datakelas.jurusan, guru.nama_guru
                                        FROM siswa, nilai, pelajaran, datakelas, guru
                                        WHERE siswa.kode_siswa=nilai.kode_siswa AND
                                        nilai.kode_pelajaran=pelajaran.kode_pelajaran AND 
                                        datakelas.kode_siswa=siswa.kode_siswa AND nilai.kode_guru=guru.kode_guru AND
                                        siswa.kode_siswa='$siswa' ORDER BY semester, nama_pelajaran");
